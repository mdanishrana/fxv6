...
\restrict dSw8snouYDYnPXIihnUClf6ZdFF1TvJyddP01Jhy01o7p8jaod1zi9spuqwid8d
...
CREATE TABLE IF NOT EXISTS public.cattle_costs (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.feed_packages (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    tenant_id uuid,
    name character varying(255) NOT NULL,
    description text,
...
CREATE TABLE IF NOT EXISTS public.feed_usage_log (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    date date NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.general_transactions (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.pregnancy_cycles (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    animal_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.semen_bank (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    code character varying(50) NOT NULL,
    bull_name character varying(100),
...
CREATE SEQUENCE IF NOT EXISTS public.system_content_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: cattle cattle_tenant_id_tag_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
CREATE INDEX IF NOT EXISTS idx_attendance_tenant ON public.attendance USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_attendance_worker ON public.attendance USING btree (worker_id);
...
CREATE INDEX IF NOT EXISTS idx_audit_logs_tenant_created ON public.audit_logs USING btree (tenant_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cattle_costs_cattle ON public.cattle_costs USING btree (cattle_id);
...
CREATE INDEX IF NOT EXISTS idx_cattle_costs_date ON public.cattle_costs USING btree (date);
...
CREATE INDEX IF NOT EXISTS idx_cattle_costs_tenant ON public.cattle_costs USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_cattle_costs_type ON public.cattle_costs USING btree (cost_type);
...
CREATE INDEX IF NOT EXISTS idx_cattle_status ON public.cattle USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_cattle_tag ON public.cattle USING btree (tag_number);
...
CREATE INDEX IF NOT EXISTS idx_cattle_tenant ON public.cattle USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_feed_items_tenant ON public.feed_items USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_feed_packages_tenant ON public.feed_packages USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_feed_usage_tenant_date ON public.feed_usage_log USING btree (tenant_id, date);
...
CREATE INDEX IF NOT EXISTS idx_gen_trans_date ON public.general_transactions USING btree (date);
...
CREATE INDEX IF NOT EXISTS idx_gen_trans_tenant ON public.general_transactions USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_gen_trans_type ON public.general_transactions USING btree (type);
...
CREATE INDEX IF NOT EXISTS idx_invoices_due_date ON public.subscription_invoices USING btree (due_date);
...
CREATE INDEX IF NOT EXISTS idx_invoices_status ON public.subscription_invoices USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_invoices_tenant ON public.subscription_invoices USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_medical_tenant_type ON public.medical_inventory USING btree (tenant_id, type);
...
CREATE INDEX IF NOT EXISTS idx_subscriptions_status ON public.tenant_subscriptions USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_subscriptions_tenant ON public.tenant_subscriptions USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_supp_purchases_date ON public.supplier_purchases USING btree (purchase_date);
...
CREATE INDEX IF NOT EXISTS idx_supp_purchases_supplier ON public.supplier_purchases USING btree (supplier_id);
...
CREATE INDEX IF NOT EXISTS idx_supp_purchases_tenant ON public.supplier_purchases USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_supplier_purchases_supplier ON public.supplier_purchases USING btree (supplier_id);
...
CREATE INDEX IF NOT EXISTS idx_supplier_purchases_tenant ON public.supplier_purchases USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_wage_payments_tenant ON public.wage_payments USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_wage_payments_worker ON public.wage_payments USING btree (worker_id);
...
CREATE INDEX IF NOT EXISTS idx_workers_tenant ON public.workers USING btree (tenant_id);
...
\unrestrict dSw8snouYDYnPXIihnUClf6ZdFF1TvJyddP01Jhy01o7p8jaod1zi9spuqwid8d
