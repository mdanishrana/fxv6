        ...
        <div className="space-y-4 md:space-y-6 animate-fade-in px-2 md:px-0">
            ...
            <div className="bg-slate-900 text-white p-4 md:p-8 rounded-xl md:rounded-2xl shadow-xl">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-slate-400 dark:text-slate-500 mt-1 md:mt-2 text-sm md:text-base">Global SaaS Management</p>
                    </div>
                    <div className="flex gap-4">
                        <div className="text-center md:text-right">
                            <p className="text-xl md:text-2xl font-bold">{tenants.length}</p>
                            <p className="text-[10px] md:text-xs text-slate-400 dark:text-slate-500 uppercase">Farms</p>
                        </div>
                        <div className="text-center md:text-right border-l border-slate-700 pl-4">
                            ...
                            <p className="text-[10px] md:text-xs text-slate-400 dark:text-slate-500 uppercase">MRR</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <>
                    ...
                    <div className="hidden md:block bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                        <table className="w-full text-left">
                            <thead className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 uppercase text-xs font-bold">
                                <tr>
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {filteredTenants.map(tenant => (
                                    <tr key={tenant.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-500 dark:text-slate-400">Owner: {tenant.ownerName}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <span className={`px-2.5 py-1 rounded-md text-xs font-bold uppercase border
                                                ${tenant.tier === 'PREMIUM' ? 'bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 border-purple-100 dark:border-purple-900/50' :
                                                    tenant.tier === 'STANDARD' ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border-blue-100 dark:border-blue-900/50' :
                                        ...
                                        <td className="px-6 py-4">
                                            <div className={`flex items-center gap-2 text-sm font-medium ${tenant.status === 'ACTIVE' ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500 dark:text-red-400'}`}>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-1">
                                                <button
                                                    ...
                                                    className="text-xs font-medium bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 px-3 py-1.5 rounded-lg transition-colors"
                                                >
                                                    Access
                                                </button>
                                                <button
                                                    onClick={() => openEditTierModal(tenant)}
                                                    className="p-1.5 rounded-lg text-emerald-500 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 transition-colors"
                                                ...
                                                <button
                                                    ...
                                                    className={`p-1.5 rounded-lg transition-colors ${tenant.status === 'ACTIVE' ? 'text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30' : 'text-emerald-500 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30'}`}
                                                ...
                                                <button
                                                    ...
                                                    className="p-1.5 rounded-lg text-slate-400 dark:text-slate-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors ml-1"
                    ...
                    <div className="md:hidden space-y-3">
                        {filteredTenants.map(tenant => (
                            <div key={tenant.id} className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-4">
                                <div className="flex justify-between items-start mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-slate-800 dark:text-slate-100 text-sm">{tenant.name}</p>
                                            <p className="text-xs text-slate-500 dark:text-slate-400">{tenant.ownerName}</p>
                                        </div>
                                    </div>
                                    <div>
                                        <div className={`flex items-center gap-1 text-xs font-medium ${tenant.status === 'ACTIVE' ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500 dark:text-red-400'}`}>
                                            <div className={`w-2 h-2 rounded-full ${tenant.status === 'ACTIVE' ? 'bg-emerald-500' : 'bg-red-500'}`}></div>
                                            {tenant.status}
                                        </div>
                                        {tenant.suspendedByDunning && (
                                ...
                                <div className="flex items-center gap-2 mb-3">
                                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase
                                        ${tenant.tier === 'PREMIUM' ? 'bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300' :
                                            tenant.tier === 'STANDARD' ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' :
                                ...
                                <div className="flex gap-2">
                                    <button
                                        onClick={() => onLoginAsTenant(tenant)}
                                        className="flex-1 text-xs font-medium bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 py-2 rounded-lg"
                                    >
                                        Access
                                    </button>
                                    <button
                                        onClick={() => openEditTierModal(tenant)}
                                        className="p-2 rounded-lg text-emerald-500 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30"
                                    >
                                        <Settings size={16} />
                                    </button>
                                    <button
                                    ...
                                    <button
                                        onClick={() => handleStatusToggle(tenant)}
                                        className={`p-2 rounded-lg ${tenant.status === 'ACTIVE' ? 'text-red-500 dark:text-red-400 bg-red-50 dark:bg-red-900/30' : 'text-emerald-500 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30'}`}
                                    >
                                        <Power size={16} />
                                    </button>
                                    <button
                                        onClick={() => handleDeleteTenant(tenant)}
                                        className="p-2 rounded-lg bg-white dark:bg-slate-800 text-slate-400 dark:text-slate-500 hover:bg-red-50 dark:hover:bg-red-900/30 hover:text-red-600"
                                    >
                                        <Trash2 size={16} />
                                    </button>
                                </div>
                            ...
                            <tbody>
                                {[...tenants]
                                    ...
                                    .map(t => {
                                        ...
                                        return (
                                            <tr key={t.id} className="border-b border-slate-100 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                                ...
                                                <td className="px-4 py-3 font-semibold text-slate-800 dark:text-slate-100 whitespace-nowrap">{t.name}</td>
                                                <td className="px-4 py-3 text-slate-700 dark:text-slate-300 whitespace-nowrap">{t.ownerName || '-'}</td>
                                                <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{t.ownerEmail || '-'}</td>
                                                <td className="px-4 py-3 text-slate-600 dark:text-slate-300 whitespace-nowrap">{(t as any).owner_mobile || (t as any).ownerMobile || '-'}</td>
                                                <td className="px-4 py-3">
                                                    <span className="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300">{t.tier}</span>
                                                </td>
                                                <td className="px-4 py-3">
                                                    <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase ${t.status === 'ACTIVE' ? 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400' : 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400'}`}>{t.status || '-'}</span>
                                                </td>
                                                <td className="px-4 py-3 font-mono text-xs text-slate-600 dark:text-slate-300 whitespace-nowrap">{t.registrationIp || '-'}</td>
                                                <td className="px-4 py-3 text-slate-600 dark:text-slate-300 whitespace-nowrap" title={t.registrationUserAgent || undefined}>
                        ...
                        <>
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                    ...
                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Total Animals (All Farms)</p>
                                </div>
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                    <div className="p-2 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg text-emerald-600 dark:text-emerald-400 w-fit mb-2"><TrendingUp size={18} /></div>
                                    <p className="text-xl md:text-2xl font-black text-emerald-600 dark:text-emerald-400">+{capacityReport.reduce((sum, r) => sum + r.animalsAddedThisMonth, 0)}</p>
                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Animal Growth This Month</p>
                                </div>
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                    <div className="p-2 bg-amber-100 dark:bg-amber-900/30 rounded-lg text-amber-600 dark:text-amber-400 w-fit mb-2"><AlertTriangle size={18} /></div>
                                    <p className="text-xl md:text-2xl font-black text-amber-600 dark:text-amber-400">{capacityReport.filter(r => (r.cattleUtilizationPct ?? 0) >= 80 || (r.userUtilizationPct ?? 0) >= 80).length}</p>
                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Farms Near Capacity (80%+)</p>
                                </div>
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                    <div className="p-2 bg-red-100 dark:bg-red-900/30 rounded-lg text-red-600 dark:text-red-400 w-fit mb-2"><AlertTriangle size={18} /></div>
                                    <p className="text-xl md:text-2xl font-black text-red-600 dark:text-red-400">{capacityReport.filter(r => r.daysToCattleLimit !== null && r.daysToCattleLimit <= 30).length}</p>
                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Forecast to Hit Limit in 30 Days</p>
                                </div>
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className={`text-xs px-3 py-1.5 rounded-lg font-medium transition-colors ${capacitySortMode === 'utilization' ? 'bg-emerald-600 text-white' : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'}`}
                                >
                                    Closest to Limit
                                </button>
                                <button
                                    onClick={() => setCapacitySortMode('largest')}
                                    className={`text-xs px-3 py-1.5 rounded-lg font-medium transition-colors ${capacitySortMode === 'largest' ? 'bg-emerald-600 text-white' : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'}`}
                                >
                                    ...
                                    <tbody>
                                        {(capacitySortMode === 'largest'
                                            ...
                                            : [...capacityReport].sort((a, b) => (b.cattleUtilizationPct ?? -1) - (a.cattleUtilizationPct ?? -1))
                                                ...
                                                <tr key={row.tenantId} className="border-b border-slate-100 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                                    <td className="px-4 py-3 font-semibold text-slate-800 dark:text-slate-100 whitespace-nowrap">{row.name}</td>
                                                    <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{row.tier}</td>
                                                    <td className="px-4 py-3 whitespace-nowrap">
                                                        {row.cattleLimit === null ? (
                                                            <span className="text-slate-500 dark:text-slate-400">{row.cattleCount} / Unlimited</span>
                                                        ) : (
                                                            <span className={row.cattleUtilizationPct! >= 90 ? 'text-red-600 dark:text-red-400 font-medium' : row.cattleUtilizationPct! >= 80 ? 'text-amber-600 dark:text-amber-400 font-medium' : 'text-slate-700 dark:text-slate-300'}>
                                                    ...
                                                    <td className="px-4 py-3 whitespace-nowrap">
                                                        {row.userLimit === null ? (
                                                            <span className="text-slate-500 dark:text-slate-400">{row.userCount} / Unlimited</span>
                                                        ) : (
                                                            <span className={row.userUtilizationPct! >= 90 ? 'text-red-600 dark:text-red-400 font-medium' : row.userUtilizationPct! >= 80 ? 'text-amber-600 dark:text-amber-400 font-medium' : 'text-slate-700 dark:text-slate-300'}>
                                                    ...
                                                    <td className="px-4 py-3 text-right">
                                                        <button
                                                            ...
                                                            className="text-xs px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-medium"
                                                        >
                                                            Manage Capacity
                                                        </button>
                                                    </td>
            ...
            {activeTab === 'plans' && (
                <div className="space-y-4">
                    <div className="flex justify-between items-center">
                        <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Manage Subscription Plans</h3>
                        <button
                            onClick={openAddPlan}
                    ...
                    {loadingPlans ? (
                        <div className="text-center py-12">
                            <Loader2 className="animate-spin mx-auto text-slate-400 dark:text-slate-500" size={32} />
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {plans.map(plan => (
                                <div key={plan.id} className={`bg-white dark:bg-slate-800 rounded-xl shadow-sm border-2 p-5 relative ${plan.isPopular ? 'border-emerald-500' : 'border-slate-200 dark:border-slate-700'}`}>
                                    {plan.isPopular && (
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            <h4 className="font-bold text-slate-800 dark:text-slate-100 text-lg">{plan.name}</h4>
                                            <p className="text-xs text-slate-500 dark:text-slate-400 uppercase">{plan.code}</p>
                                        </div>
                                        <div className="flex gap-1">
                                            <button
                                                onClick={() => openEditPlan(plan)}
                                                className="p-1.5 rounded-lg text-emerald-500 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30"
                                            >
                                                <Edit2 size={14} />
                                            </button>
                                            <button
                                                onClick={() => handleDeletePlan(plan.id)}
                                                className="p-1.5 rounded-lg text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30"
                                            >
                                                <Trash2 size={14} />
                                            </button>
                                        </div>
                                    ...
                                    <div className="mb-4">
                                        {plan.isCustom ? (
                                            <div>
                                                <p className="text-lg font-bold text-slate-800 dark:text-slate-100">Custom Pricing</p>
                                                <a href={`mailto:${plan.contactEmail}`} className="text-sm text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                                    ...
                                    <div className="border-t border-slate-100 dark:border-slate-700 pt-3">
                                        <p className="text-xs font-bold text-slate-600 dark:text-slate-300 mb-2 uppercase">Features</p>
                                        <ul className="space-y-1.5 mb-3">
                                            {plan.features.map(feature => (
                                                <li key={feature.id} className="flex justify-between items-center text-sm text-slate-700 dark:text-slate-300">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className="text-xs bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 px-2 py-1 rounded"
                                            >
                                                <Plus size={12} />
                                            </button>
                                        </div>
            ...
            {showDeleteModal && tenantToDelete && (
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                        <div className="p-5 border-b border-red-100 dark:border-red-900/50 bg-red-50 dark:bg-red-900/30 flex items-center gap-3">
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1">
                                    Type <span className="font-bold text-red-600 dark:text-red-400">{tenantToDelete.name}</span> to confirm:
                                </label>
                                <input
                                    type="text"
                            ...
                            {deleteError && (
                                <div className="p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800/50 rounded-lg text-red-700 dark:text-red-300 text-xs">{deleteError}</div>
                            )}
                        </div>
                        <div className="p-4 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-700 flex justify-end gap-3">
                            <button
                                ...
                                className="px-4 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg text-sm"
                                disabled={isDeleting}
                            >
                                Cancel
                            </button>
                ...
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                        <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 flex justify-between items-center">
                            <div>
                                <h3 className="text-lg md:text-xl font-bold text-slate-800 dark:text-slate-100">Change Package</h3>
                                <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400">{selectedTenant.name}</p>
                            </div>
                            <button onClick={() => setShowModuleModal(false)} className="text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300">
                                <X size={20} />
                            </button>
                        </div>
                        ...
                        <div className="p-4 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700 flex justify-end gap-3">
                            <button onClick={() => setShowModuleModal(false)} className="px-4 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-sm">Cancel</button>
            ...
            {showUserModal && selectedTenant && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
                        <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 flex justify-between items-center">
                            <div>
                                <h3 className="text-lg md:text-xl font-bold text-slate-800 dark:text-slate-100">{userModalView === 'users' ? 'Manage Users' : 'Login History'}</h3>
                                <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400">{selectedTenant.name}</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <button
                                ...
                                <button onClick={() => setShowUserModal(false)} className="text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300">
                                    <X size={20} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="p-4 md:p-6 space-y-4 max-h-[50vh] overflow-y-auto">
                            {userModalView === 'history' ? (
                                loadingSessions ? (
                                    ...
                                    <p className="text-center text-slate-500 dark:text-slate-400 py-4 text-sm">No login history found</p>
                                ) : (
                                    <div className="space-y-2">
                                        {tenantSessions.map((s) => (
                                            <div key={s.id} className="p-3 bg-white dark:bg-slate-800 rounded-lg border border-slate-100 dark:border-slate-700">
                                                <div className="flex justify-between items-start">
                                                    <div>
                                                        <p className="font-medium text-slate-800 dark:text-slate-100 text-sm">{s.userName} <span className="text-slate-400 dark:text-slate-500 font-normal">({s.userEmail})</span></p>
                                                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">{new Date(s.createdAt).toLocaleString()}</p>
                                                    </div>
                                                    {s.isImpersonation && (
                                                        <span className="text-[10px] px-2 py-0.5 rounded font-bold uppercase bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300">Admin Login</span>
                                                    )}
                                                </div>
                                                <p className="text-xs text-slate-400 dark:text-slate-500 mt-1 font-mono">{s.ipAddress || '-'}{s.userAgent && !s.isImpersonation ? ` · ${s.userAgent.slice(0, 60)}` : ''}</p>
                                            </div>
                                        ))}
                                    </div>
                                )
                                ...
                                <p className="text-center text-slate-500 dark:text-slate-400 py-4 text-sm">No users found</p>
                            ) : (
                                <div className="space-y-2">
                                    {tenantUsers.map(user => (
                                        <div key={user.id} className="flex justify-between items-center p-3 bg-white dark:bg-slate-800 rounded-lg">
                                            <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className={`text-[10px] px-2 py-0.5 rounded font-bold uppercase
                                                    ${user.role === 'OWNER' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300' :
                                                        user.role === 'MANAGER' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' :
                                                ...
                                                <button
                                                    ...
                                                    className="p-1 text-slate-400 dark:text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded"
                                                >
                                                    <Mail size={14} />
                                                </button>
                                                <button
                        ...
                        {userModalView === 'users' && (
                        <div className="p-4 md:p-6 border-t border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800">
                            <p className="font-medium text-slate-700 dark:text-slate-300 mb-3 text-sm">Add New User</p>
                ...
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                        <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 flex justify-between items-center">
                            ...
                            <button onClick={() => setShowPlanModal(false)} className="text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300">
                                <X size={20} />
                            </button>
                        </div>
                        <div className="p-4 md:p-6 space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-sm text-slate-700 dark:text-slate-300">Custom Plan (Contact Sales)</span>
                                </label>
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        type="checkbox"
                                        ...
                                        className="w-4 h-4 rounded border-slate-300 dark:border-slate-600"
                                    />
                                    <span className="text-sm text-slate-700 dark:text-slate-300">Most Popular</span>
                                </label>
                            </div>
                            ...
                            {planForm.isCustom ? (
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Price (PKR/month)</label>
                                        <div className="relative">
                                            <DollarSign size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500" />
                                            <input
                                                type="number"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Price (PKR/year)</label>
                                        <div className="relative">
                                            <DollarSign size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500" />
                                            <input
                                                type="number"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Cattle Limit</label>
                                    <input
                                        type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Support Level</label>
                                <select
                        ...
                        <div className="p-4 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700 flex justify-end gap-3">
                            <button onClick={() => setShowPlanModal(false)} className="px-4 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-sm">
                                Cancel
                            </button>
                            <button
                        ...
                        <>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                                    <div className="flex items-center gap-3">
                                        <div className="p-2 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg"><TrendingUp className="text-emerald-600 dark:text-emerald-400" size={20} /></div>
                                        <div>
                                            <p className="text-2xl font-bold text-slate-800 dark:text-slate-100">Rs. {(subDashboard?.mrr || 0).toLocaleString()}</p>
                                            <p className="text-xs text-slate-500 dark:text-slate-400 uppercase">Monthly Recurring</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                                    <div className="flex items-center gap-3">
                                        <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg"><Building2 className="text-blue-600 dark:text-blue-400" size={20} /></div>
                                        <div>
                                            <p className="text-2xl font-bold text-slate-800 dark:text-slate-100">{subDashboard?.active_subscriptions || 0}</p>
                                            <p className="text-xs text-slate-500 dark:text-slate-400 uppercase">Active Subs</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                                    <div className="flex items-center gap-3">
                                        <div className="p-2 bg-amber-100 dark:bg-amber-900/30 rounded-lg"><AlertTriangle className="text-amber-600 dark:text-amber-400" size={20} /></div>
                                        <div>
                                            <p className="text-2xl font-bold text-slate-800 dark:text-slate-100">{subDashboard?.overdue_invoices || 0}</p>
                                            <p className="text-xs text-slate-500 dark:text-slate-400 uppercase">Overdue</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
                                    <div className="flex items-center gap-3">
                                        <div className="p-2 bg-purple-100 dark:bg-purple-900/30 rounded-lg"><DollarSign className="text-purple-600 dark:text-purple-400" size={20} /></div>
                                        <div>
                                            <p className="text-2xl font-bold text-slate-800 dark:text-slate-100">Rs. {(subDashboard?.revenueThisMonth || 0).toLocaleString()}</p>
                                            <p className="text-xs text-slate-500 dark:text-slate-400 uppercase">This Month</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2 border-b border-slate-200 dark:border-slate-700 pb-2">
                                {(['overview', 'subscriptions', 'invoices', 'analytics'] as const).map(tab => (
                                    <button key={tab} onClick={() => setSubTab(tab)}
                                        className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${subTab === tab ? 'bg-emerald-600 text-white' : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'}`}>
                            ...
                            {subTab === 'subscriptions' && (
                                <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                                    <table className="w-full text-left text-sm">
                                        <thead className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 uppercase text-xs">
                                            <tr>
                                                <th className="px-4 py-3">Farm</th>
                                        ...
                                        <tbody className="divide-y divide-slate-100">
                                            {subscriptions.length === 0 ? (
                                                <tr><td colSpan={7} className="px-4 py-8 text-center text-slate-500 dark:text-slate-400">No subscriptions yet</td></tr>
                                            ) : subscriptions.map(sub => (
                                                <tr key={sub.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50">
                                                    <td className="px-4 py-3">
                                                        <p className="font-medium text-slate-800 dark:text-slate-100">{sub.tenantName}</p>
                                                        <p className="text-xs text-slate-500 dark:text-slate-400">{sub.ownerName}</p>
                                                    </td>
                                                    <td className="px-4 py-3">{sub.planName || '-'}</td>
                                                    <td className="px-4 py-3 font-medium">
                                                        Rs. {sub.amount.toLocaleString()}
                                                        {sub.discountType && (
                                                            <span className="ml-2 text-[10px] px-1.5 py-0.5 rounded font-bold uppercase bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300">
                                                                -{sub.discountType === 'PERCENT' ? `${sub.discountValue}%` : `Rs. ${sub.discountValue}`}
                                                            </span>
                                                        )}
                                                    </td>
                                                    <td className="px-4 py-3"><span className="text-xs bg-slate-100 dark:bg-slate-700 px-2 py-0.5 rounded">{sub.billingCycle}</span></td>
                                                    <td className="px-4 py-3">
                                                        <span className={`text-xs px-2 py-0.5 rounded font-medium ${sub.status === 'ACTIVE' ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300' :
                                                            sub.status === 'TRIAL' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' :
                                                                sub.status === 'PAST_DUE' ? 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300' :
                                                                    sub.status === 'PAUSED' ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300' :
                                                                        'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300'
                                                            }`}>{sub.status}</span>
                                                    </td>
                                                    <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{sub.nextBillingDate ? new Date(sub.nextBillingDate).toLocaleDateString() : '-'}</td>
                                                    <td className="px-4 py-3">
                                                        <div className="flex items-center justify-end gap-1 flex-wrap">
                                                            {sub.status === 'ACTIVE' && (
                                                                <button onClick={() => handleSubscriptionAction(sub.id, { status: 'PAUSED' })} className="text-xs px-2 py-1 rounded bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 hover:bg-amber-100 dark:hover:bg-amber-900/40 font-medium">Pause</button>
                                                            )}
                                                            {sub.status === 'PAUSED' && (
                                                                <button onClick={() => handleSubscriptionAction(sub.id, { status: 'ACTIVE' })} className="text-xs px-2 py-1 rounded bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-100 dark:hover:bg-emerald-900/40 font-medium">Resume</button>
                                                            )}
                                                            {sub.status === 'TRIAL' && (
                                                                <button onClick={() => handleExtendTrial(sub)} className="text-xs px-2 py-1 rounded bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/40 font-medium">Extend Trial</button>
                                                            )}
                                                            {sub.status !== 'CANCELLED' && (
                                                                <>
                                                                    <button onClick={() => openDiscountModal(sub)} className="text-xs px-2 py-1 rounded bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-900/40 font-medium">
                                                                        {sub.discountType ? 'Edit Discount' : 'Apply Discount'}
                                                                    </button>
                                                                    <button onClick={() => handleCancelSubscription(sub.id)} className="text-xs px-2 py-1 rounded bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 hover:bg-red-100 dark:hover:bg-red-900/40 font-medium">Cancel</button>
                                                                </>
                                                            )}
                                                        </div>
                                                    </td>
                            ...
                            {subTab === 'invoices' && (
                                <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                                    <table className="w-full text-left text-sm">
                                        ...
                                        <tbody className="divide-y divide-slate-100">
                                            {invoices.length === 0 ? (
                                                <tr><td colSpan={6} className="px-4 py-8 text-center text-slate-500 dark:text-slate-400">No invoices yet</td></tr>
                                            ) : invoices.map(inv => (
                                                <tr key={inv.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50">
                                                    <td className="px-4 py-3 font-mono text-xs">{inv.invoiceNumber}</td>
                                                    <td className="px-4 py-3">
                                                        <p className="font-medium text-slate-800 dark:text-slate-100">{inv.tenantName}</p>
                                                    </td>
                                                    <td className="px-4 py-3 font-medium">
                                                        Rs. {inv.totalAmount.toLocaleString()}
                                                        {inv.discountAmount > 0 && (
                                                            <span className="ml-1.5 text-[10px] text-purple-600 dark:text-purple-400">(-Rs. {inv.discountAmount.toLocaleString()} discount)</span>
                                                        )}
                                                    </td>
                                                    <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{inv.dueDate ? new Date(inv.dueDate).toLocaleDateString() : '-'}</td>
                                                    <td className="px-4 py-3">
                                                        <span className={`text-xs px-2 py-0.5 rounded font-medium ${inv.status === 'PAID' ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300' :
                                                            inv.status === 'OVERDUE' ? 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300' :
                                    ...
                                    {loadingAnalytics || !billingAnalytics ? (
                                        ...
                                        <>
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                                    <div className="p-2 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg text-emerald-600 dark:text-emerald-400 w-fit mb-2"><TrendingUp size={18} /></div>
                                                    <p className="text-xl md:text-2xl font-black text-slate-800 dark:text-slate-100">Rs. {billingAnalytics.arr.toLocaleString()}</p>
                                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">ARR</p>
                                                </div>
                                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                                    <div className="p-2 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg text-emerald-600 dark:text-emerald-400 w-fit mb-2"><DollarSign size={18} /></div>
                                                    <p className="text-xl md:text-2xl font-black text-emerald-600 dark:text-emerald-400">Rs. {billingAnalytics.revenueToday.toLocaleString()}</p>
                                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Revenue Today</p>
                                                </div>
                                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                                    <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-blue-600 dark:text-blue-400 w-fit mb-2"><Calendar size={18} /></div>
                                                    <p className="text-xl md:text-2xl font-black text-slate-800 dark:text-slate-100">Rs. {billingAnalytics.revenueThisYear.toLocaleString()}</p>
                                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Revenue This Year</p>
                                                </div>
                                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                                    <div className="p-2 bg-amber-100 dark:bg-amber-900/30 rounded-lg text-amber-600 dark:text-amber-400 w-fit mb-2"><Receipt size={18} /></div>
                                                    <p className="text-xl md:text-2xl font-black text-amber-600 dark:text-amber-400">Rs. {billingAnalytics.outstandingAmount.toLocaleString()}</p>
                                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Outstanding Invoices</p>
                                                </div>
                                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                                    <div className="p-2 bg-purple-100 dark:bg-purple-900/30 rounded-lg text-purple-600 dark:text-purple-400 w-fit mb-2"><Users size={18} /></div>
                                                    <p className="text-xl md:text-2xl font-black text-slate-800 dark:text-slate-100">{billingAnalytics.newCustomersThisMonth}</p>
                                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">New Customers (Month)</p>
                                                </div>
                                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                                    <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg text-blue-600 dark:text-blue-400 w-fit mb-2"><Check size={18} /></div>
                                                    <p className="text-xl md:text-2xl font-black text-slate-800 dark:text-slate-100">{billingAnalytics.renewalsThisMonth}</p>
                                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Renewals (Month)</p>
                                                </div>
                                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                                    <div className="p-2 bg-red-100 dark:bg-red-900/30 rounded-lg text-red-600 dark:text-red-400 w-fit mb-2"><X size={18} /></div>
                                                    <p className="text-xl md:text-2xl font-black text-red-600 dark:text-red-400">{billingAnalytics.cancellationsThisMonth}</p>
                                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Cancellations (Month)</p>
                                                </div>
                                                <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                                                    <div className="p-2 bg-red-100 dark:bg-red-900/30 rounded-lg text-red-600 dark:text-red-400 w-fit mb-2"><AlertTriangle size={18} /></div>
                                                    <p className="text-xl md:text-2xl font-black text-red-600 dark:text-red-400">{billingAnalytics.churnRatePct}%</p>
                                                    <p className="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wide">Churn Rate (Month)</p>
                                                </div>
                                            </div>

                                            <div className="grid md:grid-cols-2 gap-6">
                                                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
                                                    <h4 className="font-bold text-slate-800 dark:text-slate-100 mb-4">Revenue - Last 12 Months</h4>
                                                    <div className="h-64">
                                                ...
                                                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
                                                    <h4 className="font-bold text-slate-800 dark:text-slate-100 mb-4">Subscription Growth - Last 12 Months</h4>
                                                    <div className="h-64">
                                                        <ResponsiveContainer width="100%" height="100%">
                                            ...
                                            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                                                <div className="p-6 pb-0">
                                                    <h4 className="font-bold text-slate-800 dark:text-slate-100">Revenue by Farm</h4>
                                                </div>
                                                    ...
                                                    <table className="w-full text-sm mt-4">
                                                        ...
                                                        <tbody>
                                                            {billingAnalytics.revenueByFarm.length === 0 ? (
                                                                <tr><td colSpan={2} className="px-6 py-8 text-center text-slate-500 dark:text-slate-400">No paid invoices yet</td></tr>
                                                            ) : billingAnalytics.revenueByFarm.map((f: any) => (
                                                                <tr key={f.tenantId} className="border-b border-slate-100 dark:border-slate-700">
                                                                    <td className="px-6 py-3 font-medium text-slate-800 dark:text-slate-100">{f.tenantName}</td>
                                                                    <td className="px-6 py-3 text-right font-medium text-emerald-600 dark:text-emerald-400">Rs. {f.revenue.toLocaleString()}</td>
                                                                </tr>
                                                            ))}
                                                        </tbody>
                                                    </table>
                            ...
                            {subTab === 'overview' && (
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
                                        <h4 className="font-bold text-slate-800 dark:text-slate-100 mb-4 flex items-center gap-2"><TrendingUp size={18} /> Subscription Summary</h4>
                                        <div className="space-y-3">
                                            <div className="flex justify-between"><span className="text-slate-600 dark:text-slate-300">Active</span><span className="font-medium">{subDashboard?.active_subscriptions || 0}</span></div>
                                            <div className="flex justify-between"><span className="text-slate-600 dark:text-slate-300">Trial</span><span className="font-medium">{subDashboard?.trial_subscriptions || 0}</span></div>
                                            <div className="flex justify-between"><span className="text-slate-600 dark:text-slate-300">Past Due</span><span className="font-medium text-red-600 dark:text-red-400">{subDashboard?.past_due_subscriptions || 0}</span></div>
                                            <div className="flex justify-between"><span className="text-slate-600 dark:text-slate-300">Cancelled</span><span className="font-medium">{subDashboard?.cancelled_subscriptions || 0}</span></div>
                                        </div>
                                    </div>
                                    <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
                                        <h4 className="font-bold text-slate-800 dark:text-slate-100 mb-4 flex items-center gap-2"><FileText size={18} /> Invoice Summary</h4>
                                        <div className="space-y-3">
                                            <div className="flex justify-between"><span className="text-slate-600 dark:text-slate-300">Pending</span><span className="font-medium text-amber-600 dark:text-amber-400">{subDashboard?.pending_invoices || 0}</span></div>
                                            <div className="flex justify-between"><span className="text-slate-600 dark:text-slate-300">Overdue</span><span className="font-medium text-red-600 dark:text-red-400">{subDashboard?.overdue_invoices || 0}</span></div>
                                            <div className="flex justify-between"><span className="text-slate-600 dark:text-slate-300">Revenue This Month</span><span className="font-medium text-emerald-600 dark:text-emerald-400">Rs. {(subDashboard?.revenueThisMonth || 0).toLocaleString()}</span></div>
                                        </div>
                                    </div>
                                </div>
                            )}
            ...
            {overrideTarget && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                        <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 flex justify-between items-center">
                            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Manage Capacity - {overrideTarget.name}</h3>
                            <button onClick={() => setOverrideTarget(null)} className="text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"><X size={20} /></button>
                        </div>
                        <div className="p-4 md:p-6 space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">New animal capacity</label>
                                <div className="flex gap-2">
                                    <input
                                        type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">New user capacity</label>
                                <div className="flex gap-2">
                                    <input
                                        type="number"
                                        placeholder="e.g. 10"
                        ...
                        <div className="p-4 md:p-6 border-t border-slate-100 dark:border-slate-700 flex justify-end gap-3">
                            <button onClick={() => setOverrideTarget(null)} className="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg">Cancel</button>
            ...
            {discountTarget && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                        <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 flex justify-between items-center">
                            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Apply Discount - {discountTarget.tenantName}</h3>
                            <button onClick={() => setDiscountTarget(null)} className="text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"><X size={20} /></button>
                        </div>
                        <div className="p-4 md:p-6 space-y-4">
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                            ...
                            {discountTarget.discountType && (
                                <button onClick={handleClearDiscount} disabled={savingDiscount} className="text-xs px-3 py-2 rounded-lg bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300">
                                    Clear existing discount
                                </button>
                            )}
                        </div>
                        <div className="p-4 md:p-6 border-t border-slate-100 dark:border-slate-700 flex justify-end gap-3">
                            <button onClick={() => setDiscountTarget(null)} className="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg">Cancel</button>
            ...
            {showSubModal && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                        <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800 flex justify-between items-center">
                            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Add Subscription</h3>
                            <button onClick={() => setShowSubModal(false)} className="text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"><X size={20} /></button>
                        </div>
                        <div className="p-4 md:p-6 space-y-4">
                            <div>
                        ...
                        <div className="p-4 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700 flex justify-end gap-3">
                            <button onClick={() => setShowSubModal(false)} className="px-4 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-sm">Cancel</button>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 p-6">
                            ...
                            <div className="flex flex-col items-center justify-center h-full py-8 text-center space-y-4">
                                <div className={`p-4 rounded-full ${isSubscribed ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400' : 'bg-slate-100 dark:bg-slate-700 text-slate-400 dark:text-slate-500'}`}>
                                    <Bell size={48} />
                                </div>
                                <div>
                                ...
                                {pushError && <p className="text-red-500 dark:text-red-400 text-sm">{pushError}</p>}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="fixed bottom-6 right-6 z-40">
                ...
                {pushError && (
                    <div className="absolute bottom-full right-0 mb-2 w-48 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 text-xs p-2 rounded border border-red-200 dark:border-red-800/50">
                        {pushError}
                    </div>
                )}
            </div>
            ...
            {showAddModal && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
                        <div className="p-4 md:p-6 border-b border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800">
                            <h3 className="text-lg md:text-xl font-bold text-slate-800 dark:text-slate-100">Register New Farm</h3>
                            <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400">Create a new tenant space.</p>
                        </div>
                        <div className="p-4 md:p-6 space-y-4">
                            <div>
                        ...
                        <div className="p-4 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700">
                            {saveError && (
                                <div className="mb-3 p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800/50 rounded-lg text-red-700 dark:text-red-300 text-sm">
                                    {saveError}
                                </div>
                            )}
                            <div className="flex justify-end gap-3">
                                <button onClick={() => { setShowAddModal(false); setSaveError(null); }} className="px-4 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-sm" disabled={isSaving}>Cancel</button>
            ...
            {activeTab === 'content' && (
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Manage Auth Page Content</h3>
                            <p className="text-sm text-slate-500 dark:text-slate-400">Update marketing text visible on the login/landing page.</p>
                        </div>
                        <button
                    ...
                    {loadingContent ? (
                        ...
                        <div className="text-center py-12 text-slate-500 dark:text-slate-400">Failed to load content.</div>
                    ) : (
                        <div className="space-y-8">
                            {/* Hero Section */}
                            <div className="space-y-4">
                                <h4 className="font-bold text-slate-700 dark:text-slate-300 border-b border-slate-100 dark:border-slate-700 pb-2">Hero Section</h4>
                                <div>
                            ...
                            {/* Features Section */}
                            <div className="space-y-4">
                                <h4 className="font-bold text-slate-700 dark:text-slate-300 border-b border-slate-100 dark:border-slate-700 pb-2">Features List</h4>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {content.features.map((feature, idx) => (
                                        <div key={idx} className="border border-slate-200 dark:border-slate-700 rounded-lg p-4 bg-white dark:bg-slate-800 relative group">
                                            <div className="space-y-3">
                                                <div>
                                                    <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Icon Name</label>
                                                    <input
                                                        type="text"
                                                        value={feature.icon}
                                                        onChange={e => {
                                                ...
                                                <div>
                                                    <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Title</label>
                                                    <input
                                                        type="text"
                                                        value={feature.title}
                                                        onChange={e => {
                            ...
                            {/* Footer Section */}
                            <div className="space-y-4">
                                <h4 className="font-bold text-slate-700 dark:text-slate-300 border-b border-slate-100 dark:border-slate-700 pb-2">Footer Points</h4>
                                <div className="space-y-2">
